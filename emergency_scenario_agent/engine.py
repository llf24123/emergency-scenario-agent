...
EQUIPMENT_LIBRARY = [
    ...
    {
        'id': 'fire_robot_amphibious',
        'name': '排涝破拆一体化机器人',
        'category': '排涝/破拆机器人',
        'summary': '面向车库、地铁、涵洞等复杂积水区域，集排涝、破拆与遥控机动于一体。',
        'supported_scenarios': ['flood_response', 'subway_fire'],
        'capabilities': ['两栖遥控作业', '大流量排涝', '积水区破拆清障'],
        'deployment_roles': ['积水区排涝', '隧道破拆', '危险区替代作业'],
        'models': ['RXR-Q280L'],
        'inventory_count': 2,
        'unit_cost_rmb': 1280000,
        'recommended_quantity': 1,
        'recommended_tasks': ['车库排涝', '隧道破拆', '深积水区域遥控作业'],
    },
    {
        'id': 'fire_robot_smoke',
        'name': '排烟灭火机器人',
        'category': '隧道/地下空间机器人',
        'summary': '适合隧道、地下设施和大跨度空间火灾的细水雾排烟、灭火与机械臂救援。',
        'supported_scenarios': ['subway_fire', 'high_rise_fire'],
        'capabilities': ['正负压排烟', '大流量水炮/泡沫炮', '机械臂抓举转运'],
        'deployment_roles': ['地下空间排烟', '强攻灭火', '危险物搬运'],
        'models': ['RXR-JM200D'],
        'inventory_count': 2,
        'unit_cost_rmb': 1860000,
        'recommended_quantity': 1,
        'recommended_tasks': ['地铁站排烟', '隧道灭火', '危险区抓举转运'],
    },
    {
        'id': 'fire_robot_multifunction',
        'name': '多功能消防机器人',
        'category': '综合消防机器人',
        'summary': '兼具灭火、排烟、送风、降温、除尘和环境侦测能力，适合复杂火场。',
        'supported_scenarios': ['high_rise_fire', 'chemical_leak', 'subway_fire'],
        'capabilities': ['灭火', '排烟送风', '环境侦测', '图像采集'],
        'deployment_roles': ['综合侦察', '控火降温', '火场排烟'],
        'models': ['RXR-MY58D'],
        'inventory_count': 3,
        'unit_cost_rmb': 920000,
        'recommended_quantity': 1,
        'recommended_tasks': ['浓烟区侦察', '火场送风排烟', '现场图像回传'],
    },
    {
        'id': 'elevated_fire_robot',
        'name': '举高灭火机器人',
        'category': '举高机器人平台',
        'summary': '可远程控制行进并举升臂架，适合高层外立面灭火与窗口救援。',
        'supported_scenarios': ['high_rise_fire'],
        'capabilities': ['26m 举升作业', '远程喷射灭火', '高位观察'],
        'deployment_roles': ['高层外攻', '窗口压制', '高位侦察'],
        'models': ['RXR-M80L-26'],
        'inventory_count': 1,
        'unit_cost_rmb': 3600000,
        'recommended_quantity': 1,
        'recommended_tasks': ['高层外立面灭火', '高位窗口压制', '外围高位侦察'],
    },
    {
        'id': 'drainage_pump',
        'name': '大流量排涝泵车',
        'category': '排涝主战装备',
        'summary': '适用于城市内涝、隧道积水和无电源区域快速排涝。',
        'supported_scenarios': ['flood_response'],
        'capabilities': ['快速部署', '无电源排涝', '现场照明'],
        'deployment_roles': ['主排涝', '积水转运', '应急补排'],
        'models': ['ZBCY 防汛排涝泵车', '龙吸水供排水抢险车'],
        'inventory_count': 4,
        'unit_cost_rmb': 980000,
        'recommended_quantity': 2,
        'recommended_tasks': ['道路排涝', '地下车库抽排', '隧道抢险'],
    },
    {
        'id': 'life_detector',
        'name': '雷达生命探测仪',
        'category': '生命搜索装备',
        'summary': '可穿透墙体与废墟进行生命体征探测，适用于地震与坍塌救援。',
        'supported_scenarios': ['earthquake_rescue'],
        'capabilities': ['生命体征探测', '废墟穿透定位', '远距离搜索'],
        'deployment_roles': ['生命搜索', '坍塌定位', '搜救决策支持'],
        'models': ['DN-IV', 'TB-RadarLife'],
        'inventory_count': 6,
        'unit_cost_rmb': 240000,
        'recommended_quantity': 2,
        'recommended_tasks': ['废墟生命搜索', '墙后探测', '余震后复查'],
    },
    {
        'id': 'smoke_exhaust_truck',
        'name': '排烟消防车',
        'category': '地下空间排烟装备',
        'summary': '针对地下空间和长隧道的排烟难题，集正负压排烟、照明与细水雾于一体。',
        'supported_scenarios': ['subway_fire', 'high_rise_fire'],
        'capabilities': ['正负压排烟', '大功率照明', '细水雾降温'],
        'deployment_roles': ['地下空间排烟', '站厅排烟', '浓烟环境照明'],
        'models': ['PY10G2', 'PY330'],
        'inventory_count': 2,
        'unit_cost_rmb': 5200000,
        'recommended_quantity': 1,
        'recommended_tasks': ['地下空间排烟', '隧道送风', '高温浓烟区照明'],
    },
    {
        'id': 'lighting_unit',
        'name': '应急照明消防车',
        'category': '照明保障装备',
        'summary': '用于夜间救援、坍塌现场和大范围停电场景的移动照明与供电保障。',
        'supported_scenarios': ['earthquake_rescue', 'high_rise_fire', 'flood_response'],
        'capabilities': ['大范围照明', '应急供电', '夜间持续作业'],
        'deployment_roles': ['夜间照明', '应急供电', '搜救保障'],
        'models': ['照明消防车 GB7956.16 类', '移动照明升降平台'],
        'inventory_count': 5,
        'unit_cost_rmb': 680000,
        'recommended_quantity': 1,
